...
GitHub Copilot cloud agent can be assigned issues from GitHub and will open a pull request. Issues should state the user-visible behavior, affected flavor, acceptance criteria, and required tests. Reviewers should inspect architecture and failure modes—not only compilation or style—and require manual verification steps for flows not covered by automation.
